                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <tr>
                                        ...
                                        <td><button onclick="copyText('{{ $host_address }}')" class="btn btn-success">Copy
                                                Url</button></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Message Receiving URL: </strong></td>
                                        <td><code id="sms_url">{{ $sms_url }}</code></td>
                                        <td><button onclick="copyText('{{ $sms_url }}')" class="btn btn-success">Copy
                                                Url</button></td>
                                    </tr>
                                    <tr>
                                        <td><strong>USSD Receiving URL: </strong></td>
                                        <td><code>{{ $ussd_url }}</code></td>
                                        <td><button onclick="copyText('{{ $ussd_url }}')" class="btn btn-success">Copy
                                                Url</button></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Subscription Notification URL: </strong></td>
                                        <td><code>{{ $subscription_notify_url }}</code></td>
                                        <td><button onclick="copyText('{{ $subscription_notify_url }}')"
                                                class="btn btn-success">Copy Url</button></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
